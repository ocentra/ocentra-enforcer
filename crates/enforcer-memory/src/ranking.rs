...
mod tests {
    ...
    #[test]
    fn fuse_rrf_ranks_documents_present_in_both_retrievers_highest() {
        let corpus = vec![doc("a"), doc("b"), doc("c")];
        let fulltext = vec![
            ScoredCandidate {
                doc_id: "a".into(),
                score: 10.0,
    ...
    #[test]
    fn hard_filters_exclude_before_fusion() {
        let corpus = vec![doc("a"), doc("blocked")];
        let fulltext = vec![
            ScoredCandidate {
                doc_id: "blocked".into(),
                score: 100.0,
    ...
    #[test]
    fn candidate_not_in_corpus_is_skipped_not_panicking() {
        let corpus = vec![doc("a")];
    ...
    #[test]
    fn reranker_lift_is_zero_when_order_is_unchanged() {
        let pre = vec![
            CandidateTrace {
                doc_id: "a".into(),
    ...
    #[test]
    fn reranker_lift_is_positive_when_order_changes() {
        let pre = vec![
            CandidateTrace {
                doc_id: "a".into(),
                fulltext_rank: Some(1),
    ...
    #[test]
    fn reranker_lift_is_zero_for_empty_inputs() {
