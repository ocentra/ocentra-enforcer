...
pub fn record_model_runtime_observation_in_store(
    ...
    store.append_observation_entry(|seq| {
        ...
        ObservationLogEntryDto {
            ...
            seq,
            id: id.into(),
            lesson_id: observation.lesson_id.retained(),
            rule_id: observation.rule_id.retained(),
            fault_class: observation.fault_class.retained(),
            repo_context: observation.repo_context.retained(),
            clean: observation.clean,
            source_surface: observation.source_surface.retained(),
            ts: observation.ts.retained(),
            supersedes_seq: None,
