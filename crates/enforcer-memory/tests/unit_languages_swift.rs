...
//! spec-table engine ([`enforcer_syntax::languages::generic::parse_swift`])
...
//! [`enforcer_syntax::languages::spec::LangSpec::swift`]'s own doc
...
use enforcer_syntax::languages::generic::parse_swift;
