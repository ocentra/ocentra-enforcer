...
//! spec-table engine ([`enforcer_memory::languages::generic::parse_zig`])
...
//! [`enforcer_memory::languages::spec::LangSpec::zig`]'s own doc
...
use enforcer_memory::languages::generic::parse_zig;
