...
//! spec-table engine ([`enforcer_memory::languages::generic::parse_typst`])
...
//! [`enforcer_memory::languages::spec::LangSpec::typst`]'s own doc comment
...
use enforcer_memory::languages::generic::parse_typst;
