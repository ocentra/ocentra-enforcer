...
//! spec-table engine
//! ([`enforcer_memory::languages::generic::parse_systemverilog`]) --
...
//! recorded in
//! [`enforcer_memory::languages::spec::LangSpec::systemverilog`]'s own
...
use enforcer_memory::languages::generic::parse_systemverilog;
