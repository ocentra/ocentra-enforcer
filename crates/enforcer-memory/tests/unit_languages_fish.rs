...
//! spec-table engine ([`enforcer_syntax::languages::generic::parse_fish`])
...
//! [`enforcer_syntax::languages::spec::LangSpec::fish`]'s own doc comment
...
use enforcer_syntax::languages::generic::parse_fish;
