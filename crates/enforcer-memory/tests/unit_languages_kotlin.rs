...
//! spec-table engine ([`enforcer_syntax::languages::generic::parse_kotlin`])
...
//! [`enforcer_syntax::languages::spec::LangSpec::kotlin`]'s own doc
...
use enforcer_syntax::languages::generic::parse_kotlin;
