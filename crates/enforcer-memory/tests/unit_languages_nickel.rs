...
//! spec-table engine
//! ([`enforcer_syntax::languages::generic::parse_nickel`]) -- there is
...
//! [`enforcer_syntax::languages::spec::LangSpec::nickel`]'s own doc
...
use enforcer_syntax::languages::generic::parse_nickel;
