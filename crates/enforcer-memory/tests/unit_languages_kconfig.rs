...
//! spec-table engine
//! ([`enforcer_syntax::languages::generic::parse_kconfig`]) -- there is
...
//! recorded in [`enforcer_syntax::languages::spec::LangSpec::kconfig`]'s
...
use enforcer_syntax::languages::generic::parse_kconfig;
