...
#[test]
fn vector_exact_vector_query_returns_the_matching_document_first() {
...
#[test]
fn vector_embed_documents_dedups_repeated_doc_ids() {
    let embedder = HashingEmbedder::new();
    let docs = vec![
...
#[test]
fn embed_hashing_embedder_is_deterministic_across_calls() {
    let embedder = HashingEmbedder::new();
...
#[test]
fn embed_shared_vocabulary_queries_are_more_similar_than_disjoint_ones() {
    let embedder = HashingEmbedder::new();
