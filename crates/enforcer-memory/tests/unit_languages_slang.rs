...
//! spec-table engine ([`enforcer_memory::languages::generic::parse_slang`])
...
//! [`enforcer_memory::languages::spec::LangSpec::slang`]'s own doc comment
//! directly: this grammar's C++-shaped fields, fully reusing
//! [`enforcer_memory::languages::generic::cpp_quirks`] verbatim (no
//! Slang-specific quirk exists at all).

use enforcer_memory::languages::generic::parse_slang;
