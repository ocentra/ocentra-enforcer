...
//! spec-table engine ([`enforcer_syntax::languages::generic::parse_starlark`])
...
//! [`enforcer_syntax::languages::spec::LangSpec::starlark`]'s own doc
...
use enforcer_syntax::languages::generic::parse_starlark;
