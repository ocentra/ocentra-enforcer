...
//! spec-table engine ([`enforcer_memory::languages::generic::parse_cmake`])
...
//! [`enforcer_memory::languages::spec::LangSpec::cmake`]'s own doc comment
...
use enforcer_memory::languages::generic::parse_cmake;
