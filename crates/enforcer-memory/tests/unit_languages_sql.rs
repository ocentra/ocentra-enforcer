...
//! spec-table engine ([`enforcer_syntax::languages::generic::parse_sql`])
...
//! [`enforcer_syntax::languages::spec::LangSpec::sql`]'s own doc comment
...
use enforcer_syntax::languages::generic::parse_sql;
