...
//! spec-table engine
//! ([`enforcer_syntax::languages::generic::parse_jsonnet`]) -- there is
...
//! [`enforcer_syntax::languages::spec::LangSpec::jsonnet`]'s own doc
...
use enforcer_syntax::languages::generic::parse_jsonnet;
