...
//! spec-table engine ([`enforcer_memory::languages::generic::parse_hcl`])
...
//! [`enforcer_memory::languages::spec::LangSpec::hcl`]'s own doc comment
...
use enforcer_memory::languages::generic::parse_hcl;
