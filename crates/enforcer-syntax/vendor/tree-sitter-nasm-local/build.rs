//! Compiles the vendored NASM grammar's generated `parser.c` (no external
//! scanner for this grammar -- copied unmodified from the upstream
//! `naclsn/tree-sitter-nasm` source -- see this crate's own `Cargo.toml`
...
fn main() {
    ...
    cc::Build::new()
        ...
        .warnings(false)
        .compile("tree-sitter-nasm-local");
}
