//! Compiles the vendored Pony grammar's generated `parser.c` PLUS its
//! hand-written `scanner.c` (both copied unmodified from the upstream
//! `amaanq/tree-sitter-pony` source -- see this crate's own `Cargo.toml`
...
fn main() {
    ...
    cc::Build::new()
        ...
        .warnings(false)
        .compile("tree-sitter-pony-local");
}
