//! Compiles the vendored BitBake grammar's generated `parser.c` +
//! hand-written `scanner.c` (both copied unmodified from the upstream
//! `tree-sitter-grammars/tree-sitter-bitbake` repo -- see this crate's
...
fn main() {
    ...
    cc::Build::new()
        ...
        .warnings(false)
        .compile("tree-sitter-bitbake-local");
}
