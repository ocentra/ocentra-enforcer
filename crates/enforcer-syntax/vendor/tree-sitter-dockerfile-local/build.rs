//! Compiles the vendored Dockerfile grammar's generated `parser.c` +
//! hand-written `scanner.c` (both copied unmodified from the published
//! `tree-sitter-dockerfile` 0.2.0 crate's own `src/` -- see this
...
fn main() {
    ...
    cc::Build::new()
        ...
        .warnings(false)
        .compile("tree-sitter-dockerfile-local");
}
