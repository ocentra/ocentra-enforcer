...
/// Extracted symbol category used by language-agnostic parser facts.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum SymbolKind {
    /// A free-standing function declaration.
    Function,
    Type,
    Test,
...
impl Language {
    /// Exhaustive parser identity list used to prove registry set equality.
    pub const ALL: [Self; 160] = [
        Self::Rust,
        Self::TypeScript,
        Self::JavaScript,
        Self::Python,
