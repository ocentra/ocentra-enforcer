...
impl FileLengthValidator {
    ...
    pub fn new() -> Result<Self, enforcer_domain::boundary::decode_error::DecodeError> {
        Ok(Self {
            rule_id: crate::boundary::static_rule_id("SIZE-FILE-1.1")?,
        })
    }
}
...
impl Validator for FileLengthValidator {
    ...
    fn validate(&self, input: ValidationInput<'_>) -> Vec<Finding> {
        ...
        let cap = if source_analysis::is_rust_file(input.file) {
            FILE_LINE_CAP_RUST
        } else {
            FILE_LINE_CAP_DEFAULT
        };
        let total = source_analysis::physical_line_count(input.source.as_str());
        if total > cap {
            return vec![finding!(
                &self.rule_id,
                Severity::Error,
                "size: file exceeds the line-count cap",
...
impl FunctionLengthValidator {
    ...
    pub fn new() -> Result<Self, enforcer_domain::boundary::decode_error::DecodeError> {
        Ok(Self {
            rule_id: crate::boundary::static_rule_id("SIZE-FUNC-1.1")?,
        })
    }
}
...
impl Validator for FunctionLengthValidator {
    ...
    fn validate(&self, input: ValidationInput<'_>) -> Vec<Finding> {
        for block in source_analysis::function_blocks(input.source.as_str()) {
            let span = block
                .end_line
            ...
            if span > FUNCTION_LINE_CAP {
                return vec![finding!(
                    &self.rule_id,
                    Severity::Error,
                    "size: function exceeds the line-count cap",
                    format!(
...
impl ClassSizeValidator {
    ...
    pub fn new() -> Result<Self, enforcer_domain::boundary::decode_error::DecodeError> {
        Ok(Self {
            rule_id: crate::boundary::static_rule_id("SIZE-CLASS-1.1")?,
        })
    }
}
...
impl Validator for ClassSizeValidator {
    ...
    fn validate(&self, input: ValidationInput<'_>) -> Vec<Finding> {
        for block in source_analysis::class_blocks(input.source.as_str()) {
            let span = block
                .end_line
                .saturating_sub(block.start_line)
                .saturating_add(1);
            if span > CLASS_LINE_CAP {
                return vec![finding!(
                    &self.rule_id,
                    Severity::Error,
                    "size: class exceeds the line-count cap",
                    format!(
            ...
            if block.public_method_count > CLASS_PUBLIC_METHOD_CAP {
                return vec![finding!(
                    &self.rule_id,
                    Severity::Error,
                    "size: class exceeds the public-method-count cap",
                    format!(
...
impl ParamCountValidator {
    ...
    pub fn new() -> Result<Self, enforcer_domain::boundary::decode_error::DecodeError> {
        Ok(Self {
            rule_id: crate::boundary::static_rule_id("SIZE-PARAMS-1.1")?,
        })
    }
}
...
impl Validator for ParamCountValidator {
    ...
    fn validate(&self, input: ValidationInput<'_>) -> Vec<Finding> {
        for (line_idx, line) in input.source.as_str().lines().enumerate() {
            if !source_analysis::is_function_opener(line) {
                continue;
            }
            if let Some(count) = source_analysis::param_count_in_signature(line) {
                if count > PARAM_COUNT_CAP {
                    return vec![finding!(
                        &self.rule_id,
                        Severity::Error,
                        "size: signature exceeds the parameter-count cap",
                        format!(
...
impl LineLengthValidator {
    ...
    pub fn new() -> Result<Self, enforcer_domain::boundary::decode_error::DecodeError> {
        Ok(Self {
            rule_id: crate::boundary::static_rule_id("SIZE-LINE-1.1")?,
        })
    }
}
        ...
        for (line_idx, line) in input.source.as_str().lines().enumerate() {
            ...
            if len > LINE_LENGTH_CAP {
                return vec![finding!(
                    &self.rule_id,
                    Severity::Error,
                    "size: line exceeds the column-length cap",
                    format!(
...
impl TestFileLengthValidator {
    ...
    pub fn new() -> Result<Self, enforcer_domain::boundary::decode_error::DecodeError> {
        Ok(Self {
            rule_id: crate::boundary::static_rule_id("SIZE-TESTFILE-1.1")?,
        })
    }
}
...
impl Validator for TestFileLengthValidator {
    ...
    fn validate(&self, input: ValidationInput<'_>) -> Vec<Finding> {
        let path = input.file.as_str();
        if !source_analysis::is_test_file(input.file) {
            return Vec::new();
        }
        let total = source_analysis::physical_line_count(input.source.as_str());
        if total > TEST_FILE_LINE_CAP {
            return vec![finding!(
                &self.rule_id,
                Severity::Error,
                "size: test file exceeds the line-count cap",
                format!(
...
impl ComplexityNestingValidator {
    ...
    pub fn new() -> Result<Self, enforcer_domain::boundary::decode_error::DecodeError> {
        Ok(Self {
            rule_id: crate::boundary::static_rule_id("SIZE-CX-1.1")?,
        })
    }
}
...
impl Validator for ComplexityNestingValidator {
    ...
    fn validate(&self, input: ValidationInput<'_>) -> Vec<Finding> {
        let metrics = source_analysis::complexity_and_nesting(input.source.as_str());
        let cyclomatic_complexity = metrics.decision_points.saturating_add(1);
        let nesting_depth = metrics.nesting_depth;
        if cyclomatic_complexity >= COMPLEXITY_FIRE_THRESHOLD || nesting_depth > NESTING_DEPTH_CAP {
            return vec![finding!(
                &self.rule_id,
                Severity::Warning,
                "size: cyclomatic complexity or nesting depth crosses threshold",
                format!(
...
impl PackageNestingDepthValidator {
    ...
    pub fn new() -> Result<Self, enforcer_domain::boundary::decode_error::DecodeError> {
        Ok(Self {
            rule_id: crate::boundary::static_rule_id("SIZE-NEST-1.1")?,
        })
    }
}
    ...
    fn validate(&self, input: ValidationInput<'_>) -> Vec<Finding> {
        ...
        if depth > PACKAGE_NESTING_DEPTH_CAP {
            return vec![finding!(
                &self.rule_id,
                Severity::Warning,
                "size: package/path nesting depth crosses threshold",
                format!(
...
impl RatchetLengthValidator {
    ...
    pub fn new() -> Result<Self, enforcer_domain::boundary::decode_error::DecodeError> {
        Ok(Self {
            rule_id: crate::boundary::static_rule_id("FE-LEN-2.1")?,
        })
    }
}
...
impl Validator for RatchetLengthValidator {
    ...
    fn validate(&self, input: ValidationInput<'_>) -> Vec<Finding> {
        let Some(baseline) = source_analysis::recorded_baseline(input.source.as_str()) else {
            return Vec::new();
        };
        let total = source_analysis::physical_line_count(input.source.as_str());
        if total > baseline {
            return vec![finding!(
                &self.rule_id,
                Severity::Warning,
                "size: file grew past its recorded baseline",
                format!(
...
mod tests {
    ...
    use super::{
        validators, ClassSizeValidator, ComplexityNestingValidator, FileLengthValidator,
        FunctionLengthValidator, LineLengthValidator, PackageNestingDepthValidator,
        ParamCountValidator, RatchetLengthValidator, TestFileLengthValidator,
    };
