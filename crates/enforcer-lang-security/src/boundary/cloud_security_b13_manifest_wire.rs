...
//! references for IAM, Lambda, Azure Defender, container registry, managed
//! Kubernetes, and serverless security records. It never connects to a
//! provider, account, cluster, registry, function, scanner, runtime, network,
