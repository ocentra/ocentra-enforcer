use crate::lexer_c_like::{lex_c_like, lex_hash_comment, lex_lisp, lex_markup, lex_shell};use crate::lexer_python::lex_python;use crate::lexer_rust::lex_rust;use super::{LanguageFamily, LanguageSpec, LiteralCandidate};pub(crate) use crate::lexer_shared::line_at;pub(crate) fn lex_literals(source: &str, language: LanguageSpec, rel: &str) -> Vec<LiteralCandidate> {
