...
export function FindingsWorkspace({ report, findings, waivableRuleIds, selectedFinding, onSelectFinding, onOpenRules, onOpenHubHandoff, onWaiveFinding, onRunScan, scanTargets, scanTargetsLoading, scanTargetsError, scanHistory, onLoadScanRun, runState, scanError }: { report: UiReportPayload & { runtime?: string; persistence?: string; generatedAt?: string; runId?: string; targetLabel?: string }; findings: DisplayFinding[]; waivableRuleIds: string[]; selectedFinding?: DisplayFinding; onSelectFinding: (id: string) => void; onOpenRules: (ruleId?: string) => void; onOpenHubHandoff: (finding: DisplayFinding) => void; onWaiveFinding: (finding: DisplayFinding, owner: string, reason: string) => Promise<void>; onRunScan: (target?: ScanTarget) => void; scanTargets: ScanTarget[]; scanTargetsLoading: boolean; scanTargetsError: string; scanHistory: ScanHistoryEntry[]; onLoadScanRun: (runId: string) => void; runState: "idle" | "running" | "complete" | "failed"; scanError: string }) {
