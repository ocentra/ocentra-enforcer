...
//! BOUNDARY-INVARIANT: parse and validate settings through the typed config
//! API before rendering or persisting any control-plane value.
//! boundaryOwnerNote: enforcer-ui owns the g05 settings boundary mount.
//!
