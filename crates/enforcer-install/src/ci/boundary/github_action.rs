...
//! BOUNDARY-INVARIANT: GitHub Action input is decoded before typed rendering.
//! Negative invalid inputs are rejected during action decoding.
//!
use crate::ci::boundary::release_rendering::render_variant_label;
use enforcer_domain::install_types::BinaryVariant;

const ACTIONS_CACHE_SHA: &str = "5a3ec84eff668545956fd18022155c47e93e2684";
...
mod tests {
    ...
    fn rendered_action_yml_declares_cache_before_install() -> Result<(), Box<dyn std::error::Error>>
    {
        ...
        let cache_idx = yml
            .find("actions/cache@5a3ec84eff668545956fd18022155c47e93e2684")
            .ok_or("immutable cache action pin present")?;
        let install_idx = yml
