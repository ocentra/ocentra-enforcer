...
| **E — new languages + universal scanning** | `e01`, `e-pack-dart`, `e-pack-cfml`, `e-pack-frontend-react`, `e-pack-python` | `e01` + `d16`,`d22` | Always-on universal literal-scan T2 floor (`e01`, non-blocking, ~65 languages); four first-class language packs — Dart, CFML via CFLint shell-out, React/Next Effect-only, and Python FastAPI layered/clean-arch (`e-pack-python`, layering/DI + Python security) — all consuming `d16`/`d22`. |
