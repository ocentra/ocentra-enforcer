...
111 assigned-workpack files. Each is a **scoped work item**, not an index — open only the one you have claimed (see the stop rule in every workpack capsule). Grouped:
