...
**Empty.** This plan is newly authored; no doc has been superseded yet. The live surface is the eight root docs listed in [DOC_INDEX.md](./DOC_INDEX.md) plus the 120 workpacks under `workpacks/`.
