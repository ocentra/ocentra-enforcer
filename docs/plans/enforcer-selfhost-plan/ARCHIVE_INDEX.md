...
**Empty.** This plan is newly authored; no doc has been superseded yet. The live surface is the nine root docs listed in [DOC_INDEX.md](./DOC_INDEX.md) (including the governing [RUST_ARCHITECTURE.md](./RUST_ARCHITECTURE.md)) plus the 109 workpacks under `workpacks/`.
