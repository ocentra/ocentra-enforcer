# a-conv-27 Check Docs And Policy

<!-- agent-capsule -->
> Agent Capsule
> Plan: `enforcer-selfhost-plan`
> Doc: `Check Docs And Policy`
...
- owns: `src/check-docs.mjs, src/check-policy.mjs`
...
## Where We Are
`src/check-docs.mjs` and `src/check-policy.mjs` implement the docs and policy checks, consuming the metadata leaves and rule registry/routing.

## Where We Want To Be
Both check modules are strict TS with typed check-result outputs.
...
Blocks a-conv-28. Deps on a-conv-01, a-conv-02; owns the docs and policy check files, disjoint from governance and the checks bridge.
