...
Tier P1. Proof row asserts `cargo test -p enforcer-lang-common` exits 0 with fail/pass fixture coverage per rule. Record the artifact path in TEST_PROOF_EXPECTATIONS.md.
