...
5. Run `ocentra_enforcer_scan` or the CLI with the same scope.
6. Treat violations as hard failures.
...
5. Remove duplicated generic guard scripts only after parity.
