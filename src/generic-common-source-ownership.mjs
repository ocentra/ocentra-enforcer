...
function scanDomainAndArchitectureRules(violations, root, filePath, rel, lines, text, importText) {
  ...
  if (!enforcerToolingFile && (/(?:circular import|cycle detected|imports itself)/iu.test(importText) || (importsOwnModule(rel, importText) && !rustImportTargetsDifferentQualifiedModule(rel, importText)))) {
